-- Keep the existing production frontend working until its next deployment.
-- The legacy column name remains; its value is now consistently interpreted as
-- KPI views per day by both the editor and employee-profile synchronization.

alter table public.contracts
  rename column kpi_target_per_day to kpi_target_month;
